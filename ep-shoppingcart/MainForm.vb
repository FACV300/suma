...
Public Class MainForm
    ...
    Private Sub btnAgregar_Click(sender As Object, e As EventArgs) Handles btnAgregar.Click
        ...
        If SeccionHombres = True Then
            Select Case SeccionHombres
                Case 1
            ...
            End Select
        End If
        If SeccionMujeres = True Then
            Select Case SeccionMujeres
                Case 1
                    AlmM1 = txtCantidad.Text
                    TotalM = (AlmM1 * 120) + (AlmM2 * 190) + (AlmM3 * 125)
                    Total = TotalH + TotalM + TotalC + TotalA
                    lblTotal.Text = Total
                Case 2
                ...
                Case 3
                    ...
                    TotalM = (AlmM1 * 120) + (AlmH2 * 190) + (AlmM3 * 125)
                    Total = TotalH + TotalM + TotalC + TotalA
                    lblTotal.Text = Total
            End Select
        End If

        If SeccionCalzado = True Then

            Select Case SeccionCalzado
                Case 1
            ...
            End Select
        End If
        If SeccionAccesorios = True Then
            Select Case SeccionAccesorios
                Case 1
